...
public class aldaketaMezuak extends JFrame {
    ...
    public aldaketaMezuak(Mezuak mezuak) {
        ...
        txt_mezua.setText(mezuak.getMezua());
        ...
        contentPane.add(lblid);
        lblid.setText(String.valueOf(mezuak.getIdMezua()));
        ...
        okIkonoa.addMouseListener(new MouseAdapter() {
            ...
            public void mouseClicked(MouseEvent e) {
                ...
                if (konfirmazioa == JOptionPane.YES_OPTION) {
                    ...
                    // Mezua eguneratzea
                    mezuak.setMezua(mezua);


                    // Hornitzailea datu-basean eguneratzea
                    kudeaketaMezuak kudeaketa = new kudeaketaMezuak();
                    kudeaketa.eguneratuMezuak(mezuak);;
        ...
        lblAtzera.addMouseListener(new MouseAdapter() {
        	...
        	public void mouseClicked(MouseEvent e) {
                ...
                lblFondoa.setIcon(new ImageIcon(aldaketaMezuak.class.getResource("/media/FONDOAK_ONARTU.png")));
