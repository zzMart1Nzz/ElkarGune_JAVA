...
public class aldaketaHornitzaileak extends JFrame {
    ...
    public aldaketaHornitzaileak(Hornitzailea hornitzailea) {
     ...
     // Sarrera-kampoak
        ...
        txt_postaElektronikoa.setText(hornitzailea.getPostaElektronikoa());
        ...
        txt_telefonoa.setText(hornitzailea.getTelefonoZkia());
        ...
        contentPane.add(lblid);
        lblid.setText(String.valueOf(hornitzailea.getIdHornitzailea()));
        ...
        okIkonoa.addMouseListener(new MouseAdapter() {
            ...
            public void mouseClicked(MouseEvent e) {
                ...
                if (konfirmazioa == JOptionPane.YES_OPTION) {
                    ...
                    hornitzailea.setTelefonoZkia(telefonoZkia);
                    hornitzailea.setPostaElektronikoa(postaElektronikoa);
        ...
        lblAtzera.addMouseListener(new MouseAdapter() {
        	...
        	public void mouseClicked(MouseEvent e) {
                ...
                hp.setVisible(true);
                        ...
                        lblFondoa.setIcon(new ImageIcon(aldaketaHornitzaileak.class.getResource("/media/FONDOAK_ONARTU.png")));
